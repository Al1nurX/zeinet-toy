...
export default function MainContent() {
  ...
  return (
    <div className="mb-10 mt-12 flex flex-col items-center justify-center text-center">
      ...
      <div
        data-aos="fade-up"
        className="mb-8 text-center font-georgia text-[20px] uppercase leading-relaxed text-[#090909]"
      >
        сіз(дер)ді <br /> аяулы анамыз
      </div>
      <div data-aos="fade-up" className="mb-8 font-xxx text-4xl text-[#556B2F]">
        Гүлғайшаның
      </div>
      <div
        data-aos="fade-up"
      ...
      <div data-aos="zoom-in" className="font-xxx text-3xl text-[#556B2F]">
        Той Салтанаты:
      </div>
      ...
      <div data-aos="zoom-in" className="mt-4 font-xxx text-3xl text-[#556B2F]">
        Тойға дейін қалды:
      </div>
      <CountdownTimer />
    </div>
